  ...
  return (
    <nav className='bg-slate-900 text-white  justify-between  h-16 py-2 '>
      <div className='flex items-center justify-between max-w-[70%] mx-auto h-full '>
        ...
        <div className='flex flex-row-reverse items-end justify-center text-white font-medium cursor-pointer'>
          Github
          <a className='invert' href="http://github.com/moeez5251" target='_blank'>
